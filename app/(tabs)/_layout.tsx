...
const TabBarIcon = ({ focused, icon, title}: TabBarIconProps) =>
  <View className="tab-icon">
    ...
    <Text className={cn('text-sm font-bold', focused ? 'text-secondary':'text-gray-200')}>
      {title}
    </Text>
  </View>
...
export default function TabLayout () {
  ...
  return (<Tabs
    ...
    <Tabs.Screen
        ...
        options={{
          title: 'Delivery',
          tabBarIcon: ({ focused }) => <TabBarIcon title="Delivery" icon={images.delivery} focused={focused} />
        }}
    />
    <Tabs.Screen
        name='Profile'
